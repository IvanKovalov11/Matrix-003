...
bool multiply(float ** lhs_elements, unsigned int lhs_rows, unsigned int lhs_columns, float ** rhs_elements,
	unsigned int rhs_rows, unsigned int rhs_columns, float ** & result_elements, unsigned int & result_rows,
	unsigned int & result_columns) 
{
	unsigned int rows;
...
bool transpose(float ** lhs_elements, unsigned int lhs_rows, unsigned int lhs_columns, float ** & result_elements,
...
bool reversing(float ** lhs_elements, unsigned int lhs_rows, unsigned int lhs_columns, float ** & result_elements,
	unsigned int & result_rows, unsigned int & result_columns) 
{
...
bool read_matrix(float ** & elements, unsigned int & result_rows, unsigned int & result_columns,
	string s) 
{
	char symbol;
	ifstream stream;
